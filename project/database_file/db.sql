...
insert  into `request`(`filename`,`data`,`owner`,`status`,`email`,`p1`,`p2`,`p3`,`s1`,`s2`,`s3`) values ('ashwin.txt','hi hello how are you','ashwin','yes','ashwinml2002@gmail.com','Q60qX8qjFmcmnb74/Azwkw==','udtujiZoifc=','1uy/imCJs0Wofp003P23Lg==','c9sEYaDZeyvimVpZjy3/jw==','whCM1mFn2tY=','Fj/dGbjeDjr+bR5S/wyuhQ==');
...
insert  into `user`(`id`,`username`,`password`,`dob`,`email`,`city`,`contact`) values (2,'sai','sai','2002-05-11','ashwinml2002@gmail.com','hyd','999999999');
